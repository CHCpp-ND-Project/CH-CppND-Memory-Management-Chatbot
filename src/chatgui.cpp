...
{
    // debug statement // std::cout<<"NEW ChatbotFrame Chatgui.cpp Chatbot on init"<<std::endl;
...
{
    // debug // std::cout<<"NEW ChatBotFrameImagePanel Chatgui.cpp Creating chatbot Frame"<<std::endl;

    // create panel with background image
    ChatBotFrameImagePanel *ctrlPanel = new ChatBotFrameImagePanel(this);
    // debug // std::cout<<"NEW ChatBotPanelDialog Chatgui.cpp Creating new chatbot Dialog"<<std::endl;
    ...
    int idTextXtrl = 1;
    // debug // std::cout<<"NEW wxTextCtrl Chatgui.cpp"<<std::endl;
    ...
    // debug // std::cout<<"NEW wxBoxSizer Chatgui.cpp"<<std::endl;
...
{
    // debug statement // std::cout<<"Chatgui.cpp Processing Text"<<std::endl;
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    // debug // std::cout<<"NEW wxBoxSizer Chatgui.cpp Creating instance of ChatLogic"<<std::endl;
    ...
    //// STUDENT CODE
    ////
    // create chat logic instance that belongs to chatLogic
    // debug // std::cout<<"NEW Chatlogic Chatgui.cpp Creating instance of ChatLogic"<<std::endl;
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    //// STUDENT CODE
    ////
    // debug // std::cout<<"                          DELETE _chatlogic Unique Pointer from Chatgui.cpp"<<std::endl;
    // smart pointer takes care of delete function, no longer need to delete _chatLogic manually //delete _chatLogic;
    ////
    //// EOF STUDENT CODE
}
...
void ChatBotPanelDialog::AddDialogItem(wxString text, bool isFromUser)
{
    ...
    // debug // std::cout<<"NEW ChatBotPanelDialogItem Chatgui.cpp Creating Dialog Item"<<std::endl;
    ...
    : wxPanel(parent, -1, wxPoint(-1, -1), wxSize(-1, -1), wxBORDER_NONE)
{
    ...
    // debug // std::cout<<"NEW wxStaticBitmap Chatgui.cpp Creating window items"<<std::endl;
    ...
    // debug // std::cout<<"NEW wxStaticText Chatgui.cpp Creating window items"<<std::endl;
    ...
    // debug // std::cout<<"NEW wxBoxSizer Chatgui.cpp Creating window items"<<std::endl;
